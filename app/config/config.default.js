    ...
    // Plugins available to handle the different types of commands
        ...
        shell: {
            ...
            config: {
                ...
                // you can set `platform` to auto use different shell in different platform:
                // gnome-terminal for linux, Terminal.app for MacOS and cmd.exe for windows
                // terminal: 'platform',
            ...
            config: {
                darwin: {
                    ...
                    // .url files are cross-platform URL shortcut files.
                        ...
                        + '\n'
                        + 'URL={{url}}'
                        // Safari is picky about last line feed.
                        // The lack of it will result in sporadic empty windows.
                        + '\n',
